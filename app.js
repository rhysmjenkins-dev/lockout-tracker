...
function manhattanXAxisScale() {
    ...
    return {
        ...
        ticks: {
            autoSkip: false,
            minRotation: 0,
            maxRotation: compactLabels ? 0 : 35,
            padding: 5,
            font: { size: compactLabels ? 10 : 12 },
            callback: function(value, index) {
                const totalHands = this.getLabels().length;
                const maximumLabels = compactLabels ? 7 : 10;
                const labelStep = Math.max(1, Math.ceil(totalHands / maximumLabels));
                if (index % labelStep !== 0 && index !== totalHands - 1) return '';
...
function displayOverallStats(stats, totalSessions) {
    ...
    html += '</div>';
    html += '<div class="warning-box mt-15 mb-15 text-sm"><strong>ℹ️ Stats guide:</strong> <a href="#" class="inline-link" onclick="showScreen(\'dictionaryScreen\'); showDictionarySection(\'glossary\', \'glossarySessionTags\'); return false;">Testing sessions</a> are excluded. Hand stats include <a href="#" class="inline-link" onclick="showScreen(\'dictionaryScreen\'); showDictionarySection(\'glossary\', \'glossaryActiveSession\'); return false;">active sessions</a>; session stats use completed sessions only. <a href="#" class="inline-link" onclick="showScreen(\'dictionaryScreen\'); showDictionarySection(\'glossary\', \'glossaryAvgLockoutScore\'); return false;"><strong>Avg LO Score</strong></a> averages every declaration score, successful or false. <a href="#" class="inline-link" onclick="showScreen(\'dictionaryScreen\'); showDictionarySection(\'glossary\', \'glossaryLockoutRate\'); return false;"><strong>LO Rate</strong></a> = successful lockouts ÷ hands played; <a href="#" class="inline-link" onclick="showScreen(\'dictionaryScreen\'); showDictionarySection(\'glossary\', \'glossaryFalseLockoutRate\'); return false;"><strong>False LO Rate</strong></a> = false lockouts ÷ lockout attempts.</div>';
